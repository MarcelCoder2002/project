...
export function Router() {
    ...
    return <>
        <Route index element={<Main links={links}/>} loader={loader}></Route>
        <Route path="new" element={<New links={links}/>} action={newAction} loader={newLoader}></Route>
    </>
}
...
export function Main({links}) {
    ...
    return (
        <>
            <Content header={<Header title="Réclamations" links={links}/>} main={
                <>
